...
export default function Terms({ params }: { params: { locale: string } }) {
  return <LegalPage locale={params.locale} title="Terms of Service" intro="Effective August 10, 2026. By using Merror, you agree to these terms and the Community Guidelines.">
