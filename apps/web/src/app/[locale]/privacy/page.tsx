...
export default function Privacy({ params }: { params: { locale: string } }) {
  ...
  return <LegalPage locale={params.locale} title="Privacy Policy" intro="Effective August 10, 2026. This alpha policy explains the information Merror, operated by Fayde LLC, uses to provide the service.">
