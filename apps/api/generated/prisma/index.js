...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\denni\\Documents\\SWE\\merror\\apps\\api\\generated\\prisma-next",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "7c9af035cca4d180f0d383b79b5dc9ee4e8d538db1a846743fe40d9a151e7c48",
  "copyEngine": true
}
...
path.join(process.cwd(), "generated/prisma-next/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "generated/prisma-next/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "generated/prisma-next/schema.prisma")
